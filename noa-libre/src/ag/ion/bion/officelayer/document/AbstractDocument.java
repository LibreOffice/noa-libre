...
public abstract class AbstractDocument implements IDocument {
    ...
    public void close() {
        long millis = 50l;
        /*  geht nur für Writer und nicht für alle anderen....
        XRefreshable refresh = null;
        refresh = (XRefreshable)UnoRuntime.queryInterface(XRefreshable.class, xComponent);
        refresh.refresh();
         */
        ...
        if (xComponent != null) {
            ...
            try {
                ...
                com.sun.star.frame.XModel xModel = (com.sun.star.frame.XModel) UnoRuntime.queryInterface(com.sun.star.frame.XModel.class,
                        xComponent);
                if (xModel != null) {
                    ...
                    Thread.sleep(millis);
                    com.sun.star.util.XModifiable xModify = (com.sun.star.util.XModifiable) UnoRuntime.queryInterface(com.sun.star.util.XModifiable.class,
                            xModel);
                    Thread.sleep(millis);
                    ...
                    com.sun.star.frame.XController xController = (com.sun.star.frame.XController) UnoRuntime.queryInterface(com.sun.star.frame.XController.class,
                            xComponent);
                    Thread.sleep(millis);
                    if (xController != null) {
